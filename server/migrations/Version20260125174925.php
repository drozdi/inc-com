 ...
 */
final class Version20260125174925 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inccom_category ADD CONSTRAINT FK_619C269B7E3C61F9 FOREIGN KEY (owner_id) REFERENCES main_user (id) ON UPDATE NO ACTION ON DELETE SET NULL');
