...
export function itSupportsSystemProps<Props extends Record<string, any>, StylesApiSelectors extends string = string>(
	...
	describe('supports system properties', () => {
		...
		const predictedProviderName = options.displayName ? splittedDisplayName[splittedDisplayName.length - 1] : undefined
		...
		options.polymorphic && itIsPolymorphic({ ...options, selector: options.polymorphicSelector || options.selector })
